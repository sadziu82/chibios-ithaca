...
|         |        |   7-0: thr. (left vert.)   |                            | l
+---------+--------+----------------------------+----------------------------+ y
| ....... | ...... | ............... serial-over-radio data ................ |
+---------+--------+----------------------------+----------------------------+
| crc32   |      4 |                          crc32                          |
+---------+--------+----------------------------+----------------------------+

  SerialOverRadio Data Format
...
|         |        | 6-0: unused for now                                     |
+---------+--------+---------------------------------------------------------+
| seq     |      1 | number of bytes in this message                         |
+---------+--------+---------------------------------------------------------+
| ack     |      1 | number of bytes that must be resent from previous msg   |
+---------+--------+---------------------------------------------------------+
| data    |      n | serial-over-radio data                                  |
+---------+--------+---------------------------------------------------------+
